...
from reagent.core.exceptions import ValidationError, AgentExecutionError
from reagent.data.models.market_models import MarketTrend, SuburbStats
        ...
        try:
            ...
            if input_str and input_str.strip():
                try:
                    ...
                    logger.error(f"Unexpected error parsing input: {e}", input_str=input_str, exc_info=True)
                    raise ValidationError("input_parsing", input_str, f"Input parsing failed: {e}") from e
