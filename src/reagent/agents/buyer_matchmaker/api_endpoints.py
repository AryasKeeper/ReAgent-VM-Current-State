...
from reagent.services.vector_db_service import setup_vector_schemas, sync_properties_to_vector_db
...
async def get_buyer_matches(
    ...
    """
    try:
        from reagent.data.match_repository import match_repository as match_storage_manager
...
async def analyze_buyer_behavior(
    ...
    """
    try:
        from reagent.agents.buyer_matchmaker.tools import BuyerBehaviorAnalysisTool
...
async def sync_buyer_profiles(
    ...
    """
    try:
        from reagent.services.vector_db_service import sync_buyer_profiles_to_vector_db
...
async def generate_buyer_alerts(
    ...
    """
    try:
        from reagent.agents.buyer_matchmaker.tools import BuyerAlertGenerationTool
