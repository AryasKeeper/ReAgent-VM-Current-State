...
def validate_postcode(postcode: str) -> bool:
    ...
    # Check if it's a valid NSW postcode range
...
def validate_sydney_location(suburb: str, postcode: str) -> bool:
    ...
    # Plus some outer areas like 1000-1999 and 3000-3999
    sydney_ranges = [
        (1000, 1999),  # Some inner areas
...
def clean_property_description(description: str) -> str:
    ...
    spam_phrases = [
        "call now", "don't miss out", "act fast", "limited time",
        "exclusive offer", "must sell", "urgent sale"
    ]
